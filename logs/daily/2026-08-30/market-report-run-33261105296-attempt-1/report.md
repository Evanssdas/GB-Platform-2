# GB day-ahead market report — 2026-08-30

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-29T15:45:30.798389+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£26.38–£103.70/MWh**; daily mean **£65.36/MWh**.
- Peak demand: **26,392 MW** at **2026-08-30 20:30 BST**.
- Peak residual demand after nuclear: **14,081 MW** at **2026-08-30 20:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£16,484.34**.
- Expected Shortfall: **£18,548.22**.
- Maximum volume under the VaR limit: **60.66 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **53.91 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 466,073.0 | MWh |
| Total wind energy | 175,878.6 | MWh |
| Solar energy | 54,268.7 | MWh |
| Nuclear energy | 105,636.5 | MWh |
| Net import energy | 124,092.0 | MWh |
...
| Scenario VaR | 16,484.34 | GBP |
| Expected Shortfall | 18,548.22 | GBP |
| Worst simulated loss | 26,370.59 | GBP |
| Best simulated profit | 5,726.71 | GBP |
| VaR budget utilisation | 164.84 | % |
| ES budget utilisation | 185.48 | % |
| Maximum volume by VaR | 60.66 | MWh |
| Maximum volume by Expected Shortfall | 53.91 | MWh |
| Binding maximum permissible volume | 53.91 | MWh |
