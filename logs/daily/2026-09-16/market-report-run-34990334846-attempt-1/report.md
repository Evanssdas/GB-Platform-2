# GB day-ahead market report — 2026-09-16

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-15T15:43:34.626589+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£48.93–£120.35/MWh**; daily mean **£79.38/MWh**.
- Peak demand: **31,372 MW** at **2026-09-16 19:30 BST**.
- Peak residual demand after nuclear: **18,903 MW** at **2026-09-16 19:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£16,959.46**.
- Expected Shortfall: **£18,676.58**.
- Maximum volume under the VaR limit: **58.96 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **53.54 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 592,244.5 | MWh |
| Total wind energy | 237,250.4 | MWh |
| Solar energy | 46,004.8 | MWh |
| Nuclear energy | 84,249.5 | MWh |
| Net import energy | 69,505.9 | MWh |
...
| Scenario VaR | 16,959.46 | GBP |
| Expected Shortfall | 18,676.58 | GBP |
| Worst simulated loss | 21,770.68 | GBP |
| Best simulated profit | 3,767.42 | GBP |
| VaR budget utilisation | 169.59 | % |
| ES budget utilisation | 186.77 | % |
| Maximum volume by VaR | 58.96 | MWh |
| Maximum volume by Expected Shortfall | 53.54 | MWh |
| Binding maximum permissible volume | 53.54 | MWh |
