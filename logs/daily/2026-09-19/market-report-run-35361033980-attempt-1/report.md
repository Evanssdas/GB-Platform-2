# GB day-ahead market report — 2026-09-19

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-18T15:13:02.986570+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£0.94–£75.22/MWh**; daily mean **£25.21/MWh**.
- Peak demand: **27,145 MW** at **2026-09-19 19:30 BST**.
- Peak residual demand after nuclear: **6,607 MW** at **2026-09-19 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£6,120.14**.
- Expected Shortfall: **£7,781.21**.
- Maximum volume under the VaR limit: **163.39 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **128.51 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 503,294.5 | MWh |
| Total wind energy | 418,669.2 | MWh |
| Solar energy | 45,449.4 | MWh |
| Nuclear energy | 89,216.0 | MWh |
| Net import energy | 1,531.0 | MWh |
...
| Scenario VaR | 6,120.14 | GBP |
| Expected Shortfall | 7,781.21 | GBP |
| Worst simulated loss | 12,297.91 | GBP |
| Best simulated profit | 15,786.11 | GBP |
| VaR budget utilisation | 61.20 | % |
| ES budget utilisation | 77.81 | % |
| Maximum volume by VaR | 163.39 | MWh |
| Maximum volume by Expected Shortfall | 128.51 | MWh |
| Binding maximum permissible volume | 128.51 | MWh |
