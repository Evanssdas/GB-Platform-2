# GB day-ahead market report — 2026-08-08

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-07T12:37:14.157634+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£11.49–£90.36/MWh**; daily mean **£56.51/MWh**.
- Peak demand: **24,232 MW** at **2026-08-08 20:30 BST**.
- Peak residual demand after nuclear: **10,619 MW** at **2026-08-08 21:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£15,407.93**.
- Expected Shortfall: **£17,904.82**.
- Maximum volume under the VaR limit: **64.90 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **55.85 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 455,171.5 | MWh |
| Total wind energy | 199,059.9 | MWh |
| Solar energy | 85,571.0 | MWh |
| Nuclear energy | 80,183.0 | MWh |
| Net import energy | 113,387.4 | MWh |
...
| Scenario VaR | 15,407.93 | GBP |
| Expected Shortfall | 17,904.82 | GBP |
| Worst simulated loss | 22,119.02 | GBP |
| Best simulated profit | 7,037.75 | GBP |
| VaR budget utilisation | 154.08 | % |
| ES budget utilisation | 179.05 | % |
| Maximum volume by VaR | 64.90 | MWh |
| Maximum volume by Expected Shortfall | 55.85 | MWh |
| Binding maximum permissible volume | 55.85 | MWh |
