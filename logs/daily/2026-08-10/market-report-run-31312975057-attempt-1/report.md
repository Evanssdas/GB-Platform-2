# GB day-ahead market report — 2026-08-10

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-09T12:19:05.058108+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£64.15–£116.00/MWh**; daily mean **£83.88/MWh**.
- Peak demand: **28,337 MW** at **2026-08-10 19:30 BST**.
- Peak residual demand after nuclear: **19,602 MW** at **2026-08-10 21:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£15,585.86**.
- Expected Shortfall: **£17,098.76**.
- Maximum volume under the VaR limit: **64.16 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **58.48 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 537,930.5 | MWh |
| Total wind energy | 129,249.4 | MWh |
| Solar energy | 89,970.4 | MWh |
| Nuclear energy | 82,531.5 | MWh |
| Net import energy | 108,192.9 | MWh |
...
| Scenario VaR | 15,585.86 | GBP |
| Expected Shortfall | 17,098.76 | GBP |
| Worst simulated loss | 20,939.02 | GBP |
| Best simulated profit | 788.87 | GBP |
| VaR budget utilisation | 155.86 | % |
| ES budget utilisation | 170.99 | % |
| Maximum volume by VaR | 64.16 | MWh |
| Maximum volume by Expected Shortfall | 58.48 | MWh |
| Binding maximum permissible volume | 58.48 | MWh |
