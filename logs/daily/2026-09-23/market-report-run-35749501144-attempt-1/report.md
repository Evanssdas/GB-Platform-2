# GB day-ahead market report — 2026-09-23

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-22T15:45:41.921271+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£51.54–£111.38/MWh**; daily mean **£81.45/MWh**.
- Peak demand: **30,813 MW** at **2026-09-23 19:30 BST**.
- Peak residual demand after nuclear: **16,615 MW** at **2026-09-23 19:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£12,500.72**.
- Expected Shortfall: **£14,461.46**.
- Maximum volume under the VaR limit: **80.00 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **69.15 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 581,497.5 | MWh |
| Total wind energy | 230,068.9 | MWh |
| Solar energy | 43,748.8 | MWh |
| Nuclear energy | 79,573.5 | MWh |
| Net import energy | 67,596.8 | MWh |
...
| Scenario VaR | 12,500.72 | GBP |
| Expected Shortfall | 14,461.46 | GBP |
| Worst simulated loss | 18,544.90 | GBP |
| Best simulated profit | 9,430.73 | GBP |
| VaR budget utilisation | 125.01 | % |
| ES budget utilisation | 144.61 | % |
| Maximum volume by VaR | 80.00 | MWh |
| Maximum volume by Expected Shortfall | 69.15 | MWh |
| Binding maximum permissible volume | 69.15 | MWh |
