# GB day-ahead market report — 2026-09-10

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-09T15:20:57.524011+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£12.30–£93.45/MWh**; daily mean **£62.13/MWh**.
- Peak demand: **29,708 MW** at **2026-09-10 18:00 BST**.
- Peak residual demand after nuclear: **12,156 MW** at **2026-09-10 00:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£16,055.17**.
- Expected Shortfall: **£18,021.68**.
- Maximum volume under the VaR limit: **62.29 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **55.49 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 574,175.0 | MWh |
| Total wind energy | 270,862.8 | MWh |
| Solar energy | 43,541.1 | MWh |
| Nuclear energy | 118,488.0 | MWh |
| Net import energy | 57,441.0 | MWh |
...
| Scenario VaR | 16,055.17 | GBP |
| Expected Shortfall | 18,021.68 | GBP |
| Worst simulated loss | 22,216.70 | GBP |
| Best simulated profit | 7,272.54 | GBP |
| VaR budget utilisation | 160.55 | % |
| ES budget utilisation | 180.22 | % |
| Maximum volume by VaR | 62.29 | MWh |
| Maximum volume by Expected Shortfall | 55.49 | MWh |
| Binding maximum permissible volume | 55.49 | MWh |
