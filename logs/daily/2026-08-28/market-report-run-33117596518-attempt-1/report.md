# GB day-ahead market report — 2026-08-28

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-27T21:19:59.662638+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£39.27–£101.37/MWh**; daily mean **£74.25/MWh**.
- Peak demand: **27,223 MW** at **2026-08-28 20:00 BST**.
- Peak residual demand after nuclear: **13,670 MW** at **2026-08-28 00:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£16,471.28**.
- Expected Shortfall: **£18,223.17**.
- Maximum volume under the VaR limit: **60.71 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **54.88 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 540,417.0 | MWh |
| Total wind energy | 221,987.1 | MWh |
| Solar energy | 50,678.7 | MWh |
| Nuclear energy | 105,597.5 | MWh |
| Net import energy | 88,396.9 | MWh |
...
| Scenario VaR | 16,471.28 | GBP |
| Expected Shortfall | 18,223.17 | GBP |
| Worst simulated loss | 22,055.83 | GBP |
| Best simulated profit | 3,432.42 | GBP |
| VaR budget utilisation | 164.71 | % |
| ES budget utilisation | 182.23 | % |
| Maximum volume by VaR | 60.71 | MWh |
| Maximum volume by Expected Shortfall | 54.88 | MWh |
| Binding maximum permissible volume | 54.88 | MWh |
