# GB day-ahead market report — 2026-08-09

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-08T12:16:55.827735+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£13.25–£113.02/MWh**; daily mean **£66.93/MWh**.
- Peak demand: **25,321 MW** at **2026-08-09 20:00 BST**.
- Peak residual demand after nuclear: **14,645 MW** at **2026-08-09 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£15,981.97**.
- Expected Shortfall: **£18,008.08**.
- Maximum volume under the VaR limit: **62.57 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **55.53 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 464,683.5 | MWh |
| Total wind energy | 157,927.0 | MWh |
| Solar energy | 79,396.2 | MWh |
| Nuclear energy | 80,956.5 | MWh |
| Net import energy | 125,392.5 | MWh |
...
| Scenario VaR | 15,981.97 | GBP |
| Expected Shortfall | 18,008.08 | GBP |
| Worst simulated loss | 22,269.66 | GBP |
| Best simulated profit | 6,218.36 | GBP |
| VaR budget utilisation | 159.82 | % |
| ES budget utilisation | 180.08 | % |
| Maximum volume by VaR | 62.57 | MWh |
| Maximum volume by Expected Shortfall | 55.53 | MWh |
| Binding maximum permissible volume | 55.53 | MWh |
