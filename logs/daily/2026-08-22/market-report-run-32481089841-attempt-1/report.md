# GB day-ahead market report — 2026-08-22

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-21T12:16:35.055245+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£45.81–£100.22/MWh**; daily mean **£74.63/MWh**.
- Peak demand: **25,839 MW** at **2026-08-22 20:00 BST**.
- Peak residual demand after nuclear: **17,293 MW** at **2026-08-22 21:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£14,486.11**.
- Expected Shortfall: **£16,353.75**.
- Maximum volume under the VaR limit: **69.03 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **61.15 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 508,783.0 | MWh |
| Total wind energy | 139,804.2 | MWh |
| Solar energy | 67,658.6 | MWh |
| Nuclear energy | 94,497.5 | MWh |
| Net import energy | 111,093.2 | MWh |
...
| Scenario VaR | 14,486.11 | GBP |
| Expected Shortfall | 16,353.75 | GBP |
| Worst simulated loss | 20,435.07 | GBP |
| Best simulated profit | 3,328.91 | GBP |
| VaR budget utilisation | 144.86 | % |
| ES budget utilisation | 163.54 | % |
| Maximum volume by VaR | 69.03 | MWh |
| Maximum volume by Expected Shortfall | 61.15 | MWh |
| Binding maximum permissible volume | 61.15 | MWh |
