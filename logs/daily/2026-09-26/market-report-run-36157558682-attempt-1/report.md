# GB day-ahead market report — 2026-09-26

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-25T15:57:02.933277+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£30.47–£100.15/MWh**; daily mean **£67.66/MWh**.
- Peak demand: **26,475 MW** at **2026-09-26 20:00 BST**.
- Peak residual demand after nuclear: **14,018 MW** at **2026-09-26 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£19,987.38**.
- Expected Shortfall: **£22,261.08**.
- Maximum volume under the VaR limit: **50.03 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **44.92 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 491,617.5 | MWh |
| Total wind energy | 206,632.8 | MWh |
| Solar energy | 62,132.5 | MWh |
| Nuclear energy | 80,028.5 | MWh |
| Net import energy | 76,362.1 | MWh |
...
| Scenario VaR | 19,987.38 | GBP |
| Expected Shortfall | 22,261.08 | GBP |
| Worst simulated loss | 26,605.93 | GBP |
| Best simulated profit | 3,035.62 | GBP |
| VaR budget utilisation | 199.87 | % |
| ES budget utilisation | 222.61 | % |
| Maximum volume by VaR | 50.03 | MWh |
| Maximum volume by Expected Shortfall | 44.92 | MWh |
| Binding maximum permissible volume | 44.92 | MWh |
