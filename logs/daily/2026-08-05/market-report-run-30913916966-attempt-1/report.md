# GB day-ahead market report — 2026-08-05

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-04T13:27:49.645590+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£39.75–£95.27/MWh**; daily mean **£69.09/MWh**.
- Peak demand: **29,409 MW** at **2026-08-05 21:00 BST**.
- Peak residual demand after nuclear: **12,387 MW** at **2026-08-05 00:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£26,440.87**.
- Expected Shortfall: **£28,375.67**.
- Maximum volume under the VaR limit: **37.82 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **35.24 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 578,610.5 | MWh |
| Total wind energy | 295,726.9 | MWh |
| Solar energy | 67,285.9 | MWh |
| Nuclear energy | 71,743.0 | MWh |
| Net import energy | 86,153.3 | MWh |
...
| Scenario VaR | 26,440.87 | GBP |
| Expected Shortfall | 28,375.67 | GBP |
| Worst simulated loss | 32,890.36 | GBP |
| Best simulated profit | -498.31 | GBP |
| VaR budget utilisation | 264.41 | % |
| ES budget utilisation | 283.76 | % |
| Maximum volume by VaR | 37.82 | MWh |
| Maximum volume by Expected Shortfall | 35.24 | MWh |
| Binding maximum permissible volume | 35.24 | MWh |
