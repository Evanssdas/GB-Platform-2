# GB day-ahead market report — 2026-09-11

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-10T15:13:52.834588+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£20.31–£111.81/MWh**; daily mean **£67.59/MWh**.
- Peak demand: **26,929 MW** at **2026-09-11 20:00 BST**.
- Peak residual demand after nuclear: **18,378 MW** at **2026-09-11 19:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£15,778.57**.
- Expected Shortfall: **£18,008.88**.
- Maximum volume under the VaR limit: **63.38 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 552,917.0 | MWh |
| Total wind energy | 198,194.3 | MWh |
| Solar energy | 63,703.6 | MWh |
| Nuclear energy | 109,710.5 | MWh |
| Net import energy | 80,170.5 | MWh |
...
| Scenario VaR | 15,778.57 | GBP |
| Expected Shortfall | 18,008.88 | GBP |
| Worst simulated loss | 24,505.29 | GBP |
| Best simulated profit | 9,114.91 | GBP |
| VaR budget utilisation | 157.79 | % |
| ES budget utilisation | 180.09 | % |
| Maximum volume by VaR | 63.38 | MWh |
