# GB day-ahead market report — 2026-08-18

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-17T12:13:47.878687+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£8.59–£104.01/MWh**; daily mean **£65.34/MWh**.
- Peak demand: **28,025 MW** at **2026-08-18 21:00 BST**.
- Peak residual demand after nuclear: **17,163 MW** at **2026-08-18 21:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£13,505.71**.
- Expected Shortfall: **£15,639.20**.
- Maximum volume under the VaR limit: **74.04 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **63.94 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 526,102.5 | MWh |
| Total wind energy | 234,312.9 | MWh |
| Solar energy | 52,326.8 | MWh |
| Nuclear energy | 90,915.5 | MWh |
| Net import energy | 76,626.3 | MWh |
...
| Scenario VaR | 13,505.71 | GBP |
| Expected Shortfall | 15,639.20 | GBP |
| Worst simulated loss | 19,060.05 | GBP |
| Best simulated profit | 9,479.52 | GBP |
| VaR budget utilisation | 135.06 | % |
| ES budget utilisation | 156.39 | % |
| Maximum volume by VaR | 74.04 | MWh |
| Maximum volume by Expected Shortfall | 63.94 | MWh |
| Binding maximum permissible volume | 63.94 | MWh |
