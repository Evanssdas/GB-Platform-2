# GB day-ahead market report — 2026-08-21

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-20T12:16:48.426759+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£67.38–£109.68/MWh**; daily mean **£85.18/MWh**.
- Peak demand: **29,316 MW** at **2026-08-21 19:00 BST**.
- Peak residual demand after nuclear: **17,077 MW** at **2026-08-21 19:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£8,065.13**.
- Expected Shortfall: **£9,170.75**.
- Maximum volume under the VaR limit: **123.99 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **109.04 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 586,826.0 | MWh |
| Total wind energy | 156,098.4 | MWh |
| Solar energy | 63,020.7 | MWh |
| Nuclear energy | 90,800.5 | MWh |
| Net import energy | 102,777.3 | MWh |
...
| Scenario VaR | 8,065.13 | GBP |
| Expected Shortfall | 9,170.75 | GBP |
| Worst simulated loss | 11,464.55 | GBP |
| Best simulated profit | 3,641.40 | GBP |
| VaR budget utilisation | 80.65 | % |
| ES budget utilisation | 91.71 | % |
| Maximum volume by VaR | 123.99 | MWh |
| Maximum volume by Expected Shortfall | 109.04 | MWh |
| Binding maximum permissible volume | 109.04 | MWh |
