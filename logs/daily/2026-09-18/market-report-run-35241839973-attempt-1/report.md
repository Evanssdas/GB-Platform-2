# GB day-ahead market report — 2026-09-18

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-17T15:41:21.379519+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£19.55–£87.34/MWh**; daily mean **£45.84/MWh**.
- Peak demand: **30,154 MW** at **2026-09-18 19:30 BST**.
- Peak residual demand after nuclear: **7,978 MW** at **2026-09-18 08:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£10,542.48**.
- Expected Shortfall: **£12,819.29**.
- Maximum volume under the VaR limit: **94.85 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **78.01 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 581,894.5 | MWh |
| Total wind energy | 403,194.1 | MWh |
| Solar energy | 50,904.3 | MWh |
| Nuclear energy | 87,378.0 | MWh |
| Net import energy | 34,635.5 | MWh |
...
| Scenario VaR | 10,542.48 | GBP |
| Expected Shortfall | 12,819.29 | GBP |
| Worst simulated loss | 16,135.53 | GBP |
| Best simulated profit | 12,786.22 | GBP |
| VaR budget utilisation | 105.42 | % |
| ES budget utilisation | 128.19 | % |
| Maximum volume by VaR | 94.85 | MWh |
| Maximum volume by Expected Shortfall | 78.01 | MWh |
| Binding maximum permissible volume | 78.01 | MWh |
