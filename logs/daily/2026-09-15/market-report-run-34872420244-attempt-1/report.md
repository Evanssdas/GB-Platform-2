# GB day-ahead market report — 2026-09-15

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-14T17:03:53.672431+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£26.88–£109.84/MWh**; daily mean **£63.86/MWh**.
- Peak demand: **28,635 MW** at **2026-09-15 19:30 BST**.
- Peak residual demand after nuclear: **14,034 MW** at **2026-09-15 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£17,008.34**.
- Expected Shortfall: **£19,407.69**.
- Maximum volume under the VaR limit: **58.79 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **51.53 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 575,881.5 | MWh |
| Total wind energy | 330,320.0 | MWh |
| Solar energy | 48,107.4 | MWh |
| Nuclear energy | 77,863.0 | MWh |
| Net import energy | 50,143.8 | MWh |
...
| Scenario VaR | 17,008.34 | GBP |
| Expected Shortfall | 19,407.69 | GBP |
| Worst simulated loss | 24,344.85 | GBP |
| Best simulated profit | 9,187.26 | GBP |
| VaR budget utilisation | 170.08 | % |
| ES budget utilisation | 194.08 | % |
| Maximum volume by VaR | 58.79 | MWh |
| Maximum volume by Expected Shortfall | 51.53 | MWh |
| Binding maximum permissible volume | 51.53 | MWh |
