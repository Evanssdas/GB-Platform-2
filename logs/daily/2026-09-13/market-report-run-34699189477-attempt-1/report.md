# GB day-ahead market report — 2026-09-13

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-12T14:24:48.378964+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£33.08–£117.55/MWh**; daily mean **£76.59/MWh**.
- Peak demand: **26,104 MW** at **2026-09-13 20:00 BST**.
- Peak residual demand after nuclear: **19,122 MW** at **2026-09-13 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£17,672.12**.
- Expected Shortfall: **£19,710.96**.
- Maximum volume under the VaR limit: **56.59 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **50.73 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 477,550.0 | MWh |
| Total wind energy | 98,511.2 | MWh |
| Solar energy | 43,935.4 | MWh |
| Nuclear energy | 94,861.0 | MWh |
| Net import energy | 121,966.0 | MWh |
...
| Scenario VaR | 17,672.12 | GBP |
| Expected Shortfall | 19,710.96 | GBP |
| Worst simulated loss | 24,816.29 | GBP |
| Best simulated profit | 4,578.99 | GBP |
| VaR budget utilisation | 176.72 | % |
| ES budget utilisation | 197.11 | % |
| Maximum volume by VaR | 56.59 | MWh |
| Maximum volume by Expected Shortfall | 50.73 | MWh |
| Binding maximum permissible volume | 50.73 | MWh |
