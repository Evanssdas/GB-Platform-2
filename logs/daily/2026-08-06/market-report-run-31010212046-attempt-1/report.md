# GB day-ahead market report — 2026-08-06

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-05T13:26:45.552595+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£28.82–£105.95/MWh**; daily mean **£59.51/MWh**.
- Peak demand: **27,710 MW** at **2026-08-06 21:00 BST**.
- Peak residual demand after nuclear: **20,336 MW** at **2026-08-06 21:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£15,979.38**.
- Expected Shortfall: **£18,170.12**.
- Maximum volume under the VaR limit: **62.58 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 567,604.0 | MWh |
| Total wind energy | 233,846.8 | MWh |
| Solar energy | 69,068.4 | MWh |
| Nuclear energy | 85,431.5 | MWh |
| Net import energy | 72,197.5 | MWh |
...
| Scenario VaR | 15,979.38 | GBP |
| Expected Shortfall | 18,170.12 | GBP |
| Worst simulated loss | 23,789.14 | GBP |
| Best simulated profit | 4,619.60 | GBP |
| VaR budget utilisation | 159.79 | % |
| ES budget utilisation | 181.70 | % |
| Maximum volume by VaR | 62.58 | MWh |
