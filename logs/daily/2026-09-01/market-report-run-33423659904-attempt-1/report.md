# GB day-ahead market report — 2026-09-01

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-31T18:11:52.938803+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£13.87–£113.17/MWh**; daily mean **£66.47/MWh**.
- Peak demand: **28,392 MW** at **2026-09-01 20:00 BST**.
- Peak residual demand after nuclear: **14,182 MW** at **2026-09-01 20:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£16,166.49**.
- Expected Shortfall: **£18,168.46**.
- Maximum volume under the VaR limit: **61.86 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **55.04 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 535,699.5 | MWh |
| Total wind energy | 244,577.9 | MWh |
| Solar energy | 61,305.1 | MWh |
| Nuclear energy | 110,762.0 | MWh |
| Net import energy | 65,344.4 | MWh |
...
| Scenario VaR | 16,166.49 | GBP |
| Expected Shortfall | 18,168.46 | GBP |
| Worst simulated loss | 23,858.15 | GBP |
| Best simulated profit | 7,396.36 | GBP |
| VaR budget utilisation | 161.66 | % |
| ES budget utilisation | 181.68 | % |
| Maximum volume by VaR | 61.86 | MWh |
| Maximum volume by Expected Shortfall | 55.04 | MWh |
| Binding maximum permissible volume | 55.04 | MWh |
