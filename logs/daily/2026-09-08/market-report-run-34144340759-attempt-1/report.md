# GB day-ahead market report — 2026-09-08

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-07T16:40:30.935859+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£6.64–£89.46/MWh**; daily mean **£36.32/MWh**.
- Peak demand: **30,616 MW** at **2026-09-08 20:00 BST**.
- Peak residual demand after nuclear: **8,694 MW** at **2026-09-08 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£9,994.05**.
- Expected Shortfall: **£12,333.79**.
- Maximum volume under the VaR limit: **100.06 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **81.08 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 563,945.5 | MWh |
| Total wind energy | 398,955.5 | MWh |
| Solar energy | 48,863.0 | MWh |
| Nuclear energy | 118,968.5 | MWh |
| Net import energy | -2,438.4 | MWh |
...
| Scenario VaR | 9,994.05 | GBP |
| Expected Shortfall | 12,333.79 | GBP |
| Worst simulated loss | 17,028.29 | GBP |
| Best simulated profit | 15,642.59 | GBP |
| VaR budget utilisation | 99.94 | % |
| ES budget utilisation | 123.34 | % |
| Maximum volume by VaR | 100.06 | MWh |
| Maximum volume by Expected Shortfall | 81.08 | MWh |
| Binding maximum permissible volume | 81.08 | MWh |
