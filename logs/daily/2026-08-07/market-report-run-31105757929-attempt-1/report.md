# GB day-ahead market report — 2026-08-07

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-06T13:24:37.583625+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£37.66–£97.17/MWh**; daily mean **£70.20/MWh**.
- Peak demand: **26,758 MW** at **2026-08-07 19:30 BST**.
- Peak residual demand after nuclear: **15,807 MW** at **2026-08-07 20:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£13,846.52**.
- Expected Shortfall: **£15,304.53**.
- Maximum volume under the VaR limit: **72.22 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **65.34 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 514,932.0 | MWh |
| Total wind energy | 146,431.8 | MWh |
| Solar energy | 74,075.4 | MWh |
| Nuclear energy | 83,081.0 | MWh |
| Net import energy | 112,343.7 | MWh |
...
| Scenario VaR | 13,846.52 | GBP |
| Expected Shortfall | 15,304.53 | GBP |
| Worst simulated loss | 18,288.49 | GBP |
| Best simulated profit | 2,304.30 | GBP |
| VaR budget utilisation | 138.47 | % |
| ES budget utilisation | 153.05 | % |
| Maximum volume by VaR | 72.22 | MWh |
| Maximum volume by Expected Shortfall | 65.34 | MWh |
| Binding maximum permissible volume | 65.34 | MWh |
