# GB day-ahead market report — 2026-08-20

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-08-19T12:15:12.766154+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£56.40–£110.37/MWh**; daily mean **£84.50/MWh**.
- Peak demand: **30,762 MW** at **2026-08-20 21:00 BST**.
- Peak residual demand after nuclear: **20,579 MW** at **2026-08-20 20:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£7,638.83**.
- Expected Shortfall: **£8,833.69**.
- Maximum volume under the VaR limit: **130.91 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **113.20 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 589,934.5 | MWh |
| Total wind energy | 151,469.6 | MWh |
| Solar energy | 57,218.2 | MWh |
| Nuclear energy | 90,947.0 | MWh |
| Net import energy | 96,189.6 | MWh |
...
| Scenario VaR | 7,638.83 | GBP |
| Expected Shortfall | 8,833.69 | GBP |
| Worst simulated loss | 11,865.69 | GBP |
| Best simulated profit | 6,847.08 | GBP |
| VaR budget utilisation | 76.39 | % |
| ES budget utilisation | 88.34 | % |
| Maximum volume by VaR | 130.91 | MWh |
| Maximum volume by Expected Shortfall | 113.20 | MWh |
| Binding maximum permissible volume | 113.20 | MWh |
