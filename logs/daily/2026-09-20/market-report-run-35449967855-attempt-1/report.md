# GB day-ahead market report — 2026-09-20

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-19T14:50:50.160447+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£10.18–£114.20/MWh**; daily mean **£47.96/MWh**.
- Peak demand: **29,318 MW** at **2026-09-20 18:30 BST**.
- Peak residual demand after nuclear: **17,862 MW** at **2026-09-20 19:30 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£4,528.65**.
- Expected Shortfall: **£6,198.03**.
- Maximum volume under the VaR limit: **220.82 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **161.34 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 556,131.0 | MWh |
| Total wind energy | 336,335.3 | MWh |
| Solar energy | 60,771.2 | MWh |
| Nuclear energy | 89,578.0 | MWh |
| Net import energy | 50,408.1 | MWh |
...
| Scenario VaR | 4,528.65 | GBP |
| Expected Shortfall | 6,198.03 | GBP |
| Worst simulated loss | 9,219.33 | GBP |
| Best simulated profit | 17,105.43 | GBP |
| VaR budget utilisation | 45.29 | % |
| ES budget utilisation | 61.98 | % |
| Maximum volume by VaR | 220.82 | MWh |
| Maximum volume by Expected Shortfall | 161.34 | MWh |
| Binding maximum permissible volume | 161.34 | MWh |
