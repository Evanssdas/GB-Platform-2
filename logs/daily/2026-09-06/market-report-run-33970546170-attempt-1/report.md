# GB day-ahead market report — 2026-09-06

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-05T14:01:03.166781+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£-5.36–£79.21/MWh**; daily mean **£40.37/MWh**.
- Peak demand: **26,509 MW** at **2026-09-06 19:30 BST**.
- Peak residual demand after nuclear: **12,674 MW** at **2026-09-06 00:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£11,752.85**.
- Expected Shortfall: **£13,826.21**.
- Maximum volume under the VaR limit: **85.09 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **72.33 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 510,186.0 | MWh |
| Total wind energy | 283,753.9 | MWh |
| Solar energy | 63,706.8 | MWh |
| Nuclear energy | 118,699.0 | MWh |
| Net import energy | 62,669.5 | MWh |
...
| Scenario VaR | 11,752.85 | GBP |
| Expected Shortfall | 13,826.21 | GBP |
| Worst simulated loss | 18,489.16 | GBP |
| Best simulated profit | 13,803.56 | GBP |
| VaR budget utilisation | 117.53 | % |
| ES budget utilisation | 138.26 | % |
| Maximum volume by VaR | 85.09 | MWh |
| Maximum volume by Expected Shortfall | 72.33 | MWh |
| Binding maximum permissible volume | 72.33 | MWh |
