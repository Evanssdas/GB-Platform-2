# GB day-ahead market report — 2026-09-05

**Model:** `core-12m-operational-v1`  
**Profile:** `core_without_battery`  
**Issue time:** `2026-09-04T15:09:49.988533+00:00`  
**Monte Carlo scenarios:** `1,000`  
**Settlement periods:** `48`

## Executive summary

- P50 price range: **£0.57–£109.64/MWh**; daily mean **£41.04/MWh**.
- Peak demand: **27,145 MW** at **2026-09-05 20:00 BST**.
- Peak residual demand after nuclear: **17,682 MW** at **2026-09-05 20:00 BST**.
- Scenario VaR for the illustrative 100 MWh position: **£6,274.16**.
- Expected Shortfall: **£8,000.79**.
- Maximum volume under the VaR limit: **159.38 MWh**.
- Conservative binding maximum under both VaR and Expected Shortfall: **124.99 MWh**.
...
| metric | value | unit |
|---|---|---|
| Demand energy | 553,516.5 | MWh |
| Total wind energy | 284,694.4 | MWh |
| Solar energy | 69,447.1 | MWh |
| Nuclear energy | 117,896.0 | MWh |
| Net import energy | 55,495.0 | MWh |
...
| Scenario VaR | 6,274.16 | GBP |
| Expected Shortfall | 8,000.79 | GBP |
| Worst simulated loss | 11,478.62 | GBP |
| Best simulated profit | 16,612.96 | GBP |
| VaR budget utilisation | 62.74 | % |
| ES budget utilisation | 80.01 | % |
| Maximum volume by VaR | 159.38 | MWh |
| Maximum volume by Expected Shortfall | 124.99 | MWh |
| Binding maximum permissible volume | 124.99 | MWh |
